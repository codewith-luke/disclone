    ...
    return (
        <>
            <div class="h-full flex flex-col justify-between">
                <main class="lg:pl-20 h-full relative">
                    ...
                    {/* NOTE: Desktop Nav*/}
                    <div
                        class="flex-col justify-between border border-border hidden h-full lg:absolute lg:inset-y-0 lg:left-0 lg:z-50 lg:flex lg:w-20 lg:overflow-y-auto lg:bg-background lg:pb-4">
                        <div>
                    ...
                    <div class="h-full xl:pl-96">
                        <div class="h-full px-4 py-10 sm:px-6 lg:px-8 lg:py-6 bg-contrast">
                            <Outlet/>
                        </div>
                    </div>

                    <aside
                        class="absolute inset-y-0 left-20 hidden w-96 overflow-y-auto border-r border-border px-4 py-6 sm:px-6 lg:px-8 xl:block">
